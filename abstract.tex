\begin{abstract}
  ...
  We propose four properties for burn protocols. \emph{Correctness}, which mandates
  that an honestly created burn address verifies correctly; \emph{unspendability},
  ...
  Next, we propose a novel construction for burning which is simple
